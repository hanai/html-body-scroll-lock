...
const setOverflowHiddenPc = () => {
    const $body = $('body')
    const bodyStyle = pick($body.style, ['overflow', 'boxSizing', 'paddingRight'])
...
const setOverflowHiddenMobile = () => {
    ...
    const htmlStyle = pick($html.style, ['height', 'overflow'])
    const bodyStyle = pick($body.style, ['top', 'width', 'height', 'overflow', 'position'])
